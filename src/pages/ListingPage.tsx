...
import { listingsAtom, fetchListingsAtom, listingsLoadingAtom, listingsFetchedAtom } from '../stores/listingStore';
...
export default function ListingPage() {
  ...
  const [isListingsLoading] = useAtom(listingsLoadingAtom);
  const [listingsFetched] = useAtom(listingsFetchedAtom);
        ...
        <div className="max-w-4xl mx-auto space-y-4">
          <div className="flex justify-between mb-4 space-x-2">
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                <MagnifyingGlassIcon className="h-5 w-5 text-white stroke-2" />
              </button>
            </div>
          </div>
