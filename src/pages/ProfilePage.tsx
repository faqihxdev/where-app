...
import {
  Button, Input, FormControl, FormLabel, FormErrorMessage, useToast, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, ModalFooter, useDisclosure
} from '@chakra-ui/react';
import { FaUser, FaEnvelope, FaCalendarAlt } from 'react-icons/fa';
import { getAuth, updatePassword, EmailAuthProvider, deleteUser, reauthenticateWithCredential } from 'firebase/auth';
        ...
        <div className="bg-gray-50 p-4 rounded-lg mt-6 shadow-inner">
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            {userData?.createdAt?.seconds && (
              <div className="bg-white p-4 rounded-md shadow-sm">
                <h3 className="text-gray-700 font-medium text-sm mb-1 flex items-center">
                  <FaCalendarAlt className="mr-2" /> Account Created At:
                </h3>
