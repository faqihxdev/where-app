  ...
  return (
    <div className='min-h-full bg-white p-4'>
      ...
      <div className='bg-gray-100 p-4 rounded-md mt-4'>
        ...
        <pre className='whitespace-pre-wrap break-words'>{JSON.stringify(userData, null, 2)}</pre>
      </div>

      <div className='bg-gray-100 p-4 rounded-md mt-4 mb-4'>
        <h2 className='text-lg font-semibold mb-2'>Auth User:</h2>
        <pre className='whitespace-pre-wrap break-words'>{JSON.stringify(authUser, null, 2)}</pre>
      </div>
    </div>
  );
};
