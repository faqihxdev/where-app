    ...
    <VStack spacing={4} align="stretch">
      ...
      <FormControl>
        ...
        <Select
          ...
          onChange={(e) => setSearchParams({ ...searchParams, category: e.target.value as ListingCategory })}
        >
      ...
      <FormControl>
        ...
        <Select
          ...
          onChange={(e) => setSearchParams({ ...searchParams, status: e.target.value as ListingStatus })}
        >
      ...
      <FormControl>
        ...
        <HStack>
          ...
          <Select
            ...
            onChange={(e) => setSearchParams({ ...searchParams, sortOrder: e.target.value as 'ascending' | 'descending' })}
          >
